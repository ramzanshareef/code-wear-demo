...
export default function Home() {
    return (
        <>
            <Head>
                <title>Code Wear - wear the code</title>
                    ...
                    <section className="text-gray-600 body-font p-4">
                        <div className="container px-5 py-24 mx-auto">
                            <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
                                <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Code wear</h1>
                                <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">
                                    Franzen you probably haven't heard of them. Wear the code you write.
                                </p>
                            </div>
