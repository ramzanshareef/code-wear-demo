                    ...
                    <div className="lg:w-4/5 mx-auto flex flex-wrap items-center justify-center text-sm md:text-base">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <p className="leading-relaxed">
                                A nice t shirt with the code you write. It's a nice t shirt. You should buy it. And wear it. And write code.
                            </p>
                            ...
                            <div className="flex">
                                ...
                                <button className="flex ml-6 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Add To Cart</button>
